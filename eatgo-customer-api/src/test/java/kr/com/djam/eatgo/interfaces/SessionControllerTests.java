...
import kr.com.djam.eatgo.application.UserService;
import kr.com.djam.eatgo.domain.User;
import kr.com.djam.eatgo.utils.JwtUtil;
...
class SessionControllerTests {
   ...
   /* @Test
    public void createWithNotExistedEmail() throws Exception{
        given(userService.authenticate("x@example","test"))
                .willThrow(EmailNotExistedException.class);

        mvc.perform(post("/session")
                .contentType(MediaType.APPLICATION_JSON)
                .content(("{\"email\":\"x@exa1mple.com\",\"password\":\"test\"}")))
...
*/
    ...
    public void createWithWrongPassword() throws Exception{
       ...
       /* mvc.perform(post("/session")
                .contentType(MediaType.APPLICATION_JSON)
                .content(("{\"email\":\"tester@exa1mple.com\",\"password\":\"test\"}")))
                .andExpect(status().isBadRequest());
*/
